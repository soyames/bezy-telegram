...
function applyLocale() {
  ...
  setText('messages-title', t('app.messages')); setText('protected-label', t('app.protected_by_bezy')); setText('profile-title', t('app.my_profile')); setText('profile-refresh-label', t('app.refresh')); setText('edit-profile', t('app.edit_profile')); setText('settings-privacy-label', t('app.settings_privacy')); setText('core-profile-label', t('app.core_profile')); setText('saved-badge', t('app.saved_badge'));
