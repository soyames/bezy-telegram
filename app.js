...
function applyLocale() {
  ...
  setText('discoverable-label', t('app.show_profile')); setText('save-profile', t('app.save_profile')); setText('language-title', t('app.language')); setText('legal-title', t('app.legal_privacy')); setText('privacy-link', t('app.privacy')); setText('terms-link', t('app.terms')); setText('support-title', t('app.support_title')); setText('support-intro', t('app.support_intro')); setText('support-bot-btn', t('app.support_bot')); setText('support-contact-btn', t('app.support_contact')); setText('support-history-btn', t('app.support_history')); setText('support-expectation', t('app.support_expectation')); setText('support-email-btn', t('app.support_email'));
...
function bindEvents() {
  ...
  if ($('support-contact-btn')) $('support-contact-btn').onclick = openSupportForm;
