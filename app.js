...
function openTelegramLink(url) {
  ...
  // Last resort for tg://: hand the custom scheme to the system opener rather than doing
  // nothing. Without this, a client without openTelegramLink left the button silently dead.
  if (url.startsWith('tg://')) { window.location.href = url; return; }
