...
function applyLocale() {
  ...
  setText('safety-title', t('app.safety_title')); setText('safety-intro', t('app.safety_intro')); setText('data-title', t('app.data_title')); setText('data-controls-btn', t('app.data_controls')); setText('rights-note', t('app.rights_note'));
